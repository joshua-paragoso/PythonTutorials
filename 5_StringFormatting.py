...
# "tuple" (a fixed size list), together with a format string, which 
# contains normal text together with "argument specifiers", special 
# symbols like "%s" and "%d".

# Let's say you have a variable called "name" with your user name in 
# it, and you would then like to print(out a greeting to that user.)
