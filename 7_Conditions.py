...
# Here are some examples for objects which are considered as empty: 1. An empty string: "" 2.
# An empty list: [] 3. The number zero: 0 4. The false boolean variable: False
...
#--The 'not' operator-----
# Using "not" before a boolena expression inverts its:
